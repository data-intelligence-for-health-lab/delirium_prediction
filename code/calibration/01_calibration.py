...
# argument #1
combinations = [5651, 3057, 1395, 756, 810, 473, 693, 747, 4619, 2909, 1555, 1609,
                2421, 3563, 4571, 267, 2173, 2441, 4995, 4113, 3525, 5627, 3489,
                4119, 5637, 3759, 4341, 2399, 2435, 1960]
...
for combination in combinations:
    # Creating combination index
    idx_combination = combinations.index(combination)

    # loading model
    model = tf.keras.models.load_model('/project/M-ABeICU176709/delirium/data/outputs/models/{:06d}/model.hdf5'.format(combination))

    # loading data
    X_adm_calibration  = pickle.load(open('/project/M-ABeICU176709/delirium/data/inputs/preprocessed/X_adm5y_calibration.pickle', 'rb'))
    X_temp_calibration = pickle.load(open('/project/M-ABeICU176709/delirium/data/inputs/preprocessed/X_temp_calibration.pickle', 'rb'))
    y_12h_calibration  = pickle.load(open('/project/M-ABeICU176709/delirium/data/inputs/preprocessed/y_12h_calibration.pickle', 'rb'))
    y_24h_calibration  = pickle.load(open('/project/M-ABeICU176709/delirium/data/inputs/preprocessed/y_24h_calibration.pickle', 'rb'))
...
# -----------------------------------------------------------------------------
    ...
    # Saving calibrators
    pickle.dump(ps_12h, open('/project/M-ABeICU176709/delirium/data/outputs/calibration/calibrators/{}_ps_12h.pickle'.format(combination), 'wb'), protocol = 4)
    pickle.dump(ps_24h, open('/project/M-ABeICU176709/delirium/data/outputs/calibration/calibrators/{}_ps_24h.pickle'.format(combination), 'wb'), protocol = 4)
    pickle.dump(ir_12h, open('/project/M-ABeICU176709/delirium/data/outputs/calibration/calibrators/{}_ir_12h.pickle'.format(combination), 'wb'), protocol = 4)
    pickle.dump(ir_24h, open('/project/M-ABeICU176709/delirium/data/outputs/calibration/calibrators/{}_ir_24h.pickle'.format(combination), 'wb'), protocol = 4)
...
# -----------------------------------------------------------------------------
 ...
 # reliability plots - generating plots
    ...
    plt.legend(loc = 0)
    plt.savefig('/project/M-ABeICU176709/delirium/data/outputs/calibration/reliability_plot_12h_{}.png'.format(combination),
                dpi = 300)
    ...
    plt.ylabel('Fraction of positives')
    plt.legend(loc = 0)
    plt.savefig('/project/M-ABeICU176709/delirium/data/outputs/calibration/reliability_plot_24h_{}.png'.format(combination),
                dpi = 300)

#    # Platt'scaling 12h
#    plt.figure()
#    plt.plot([0, 1], [0, 1], linestyle = '--', label = 'Perfectly calibrated')
#    plt.plot(prob_pred_12h_ps, prob_true_12h_ps, marker = '.')
#    plt.xlabel('Prediction')
#    plt.ylabel('Fraction of positives')
#    plt.legend(loc = 0)
#    plt.savefig('/project/M-ABeICU176709/delirium/data/outputs/calibration/reliability_plot_ps_12h_{}.png'.format(combination),
#                dpi = 300)

#    # Platt's scaling 24h
#    plt.figure()
#    plt.plot([0, 1], [0, 1], linestyle = '--', label = 'Perfectly calibrated')
#    plt.plot(prob_pred_24h_ps, prob_true_24h_ps, marker = '.')
#    plt.xlabel('Prediction')
#    plt.ylabel('Fraction of positives')
#    plt.legend(loc = 0)
#    plt.savefig('/project/M-ABeICU176709/delirium/data/outputs/calibration/reliability_plot_ps_24h_{}.png'.format(combination),
#                dpi = 300)

#    # Isotonic regression 12h
#    plt.figure()
#    plt.plot([0, 1], [0, 1], linestyle = '--', label = 'Perfectly calibrated')
#    plt.plot(prob_pred_12h_ir, prob_true_12h_ir, marker = '.')
#    plt.xlabel('Prediction')
#    plt.ylabel('Fraction of positives')
#    plt.legend(loc = 0)
#    plt.savefig('/project/M-ABeICU176709/delirium/data/outputs/calibration/reliability_plot_ir_12h_{}.png'.format(combination),
#                dpi = 300)

#    # Isotonic regression 24h
#    plt.figure()
#    plt.plot([0, 1], [0, 1], linestyle = '--', label = 'Perfectly calibrated')
#    plt.plot(prob_pred_24h_ir, prob_true_24h_ir, marker = '.')
#    plt.xlabel('Prediction')
#    plt.ylabel('Fraction of positives')
#    plt.legend(loc = 0)
#    plt.savefig('/project/M-ABeICU176709/delirium/data/outputs/calibration/reliability_plot_ir_24h_{}.png'.format(combination),
#                dpi = 300)
...
output.to_csv('/project/M-ABeICU176709/delirium/data/outputs/calibration/calibration_results.csv', index = False)
print(output)
# ------------------------------------------------------------ main routine ---
