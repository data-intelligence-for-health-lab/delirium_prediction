...
# argument #1
combinations = [3057] # highest mean auc (12h & 24h) & highest f1-score in calibration results
...
for combination in combinations:
    ...
    # loading data
#    X_adm  = pickle.load(open('/project/M-ABeICU176709/delirium/data/inputs/preprocessed/X_adm5y_validation.pickle', 'rb'))
#    X_temp = pickle.load(open('/project/M-ABeICU176709/delirium/data/inputs/preprocessed/X_temp_validation.pickle', 'rb'))
#    y_12h  = pickle.load(open('/project/M-ABeICU176709/delirium/data/inputs/preprocessed/y_12h_validation.pickle', 'rb'))
#    y_24h  = pickle.load(open('/project/M-ABeICU176709/delirium/data/inputs/preprocessed/y_24h_validation.pickle', 'rb'))
...
# -----------------------------------------------------------------------------
    ...
    # 12h
    ps_12h = pickle.load(open('/project/M-ABeICU176709/delirium/data/outputs/calibration/calibrators/{}_ps_12h.pickle'.format(combination), 'rb'))
    y_12h_pred_ps = ps_12h.predict_proba(y_12h_pred)[:,1]

    # 24h
    ps_24h = pickle.load(open('/project/M-ABeICU176709/delirium/data/outputs/calibration/calibrators/{}_ps_24h.pickle'.format(combination), 'rb'))
...
# -----------------------------------------------------------------------------
    ...
    plt.legend(loc = 0)
    plt.savefig('/project/M-ABeICU176709/delirium/data/outputs/test/reliability_plot_12h_{}_test.png'.format(combination),
#    plt.savefig('/project/M-ABeICU176709/delirium/data/outputs/test/reliability_plot_12h_{}.png'.format(combination),
                dpi = 300)
    ...
    plt.ylabel('Fraction of positives')
    plt.legend(loc = 0)
    plt.savefig('/project/M-ABeICU176709/delirium/data/outputs/test/reliability_plot_24h_{}_test.png'.format(combination),
#    plt.savefig('/project/M-ABeICU176709/delirium/data/outputs/test/reliability_plot_24h_{}.png'.format(combination),
                dpi = 300)
...
# -----------------------------------------------------------------------------
        ...
        # Appplying besst threshold according to calibration
        threshold = 0.37
...
#output.to_csv('/project/M-ABeICU176709/delirium/data/outputs/test/rerun_validation_results.csv', index = False)
output.to_csv('/project/M-ABeICU176709/delirium/data/outputs/test/test_results.csv', index = False)
print(output)
# ------------------------------------------------------------ main routine ---
